...
public interface UserImpersonationService {
	 ...
	 * @param targetUserId This is the user id of the user that the service account is trying to impersonate
	 ...
	 */
	Uni<User> impersonateUser(User currentUser, String targetUserId);
}
