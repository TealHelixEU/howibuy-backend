...
import static eu.tealhelix.betterme.v1.types.RetailerIdTestUtils.hasRetailerId;
import static eu.tealhelix.betterme.v1.types.RetailerIdTestUtils.matchesRetailerId;
...
import eu.tealhelix.betterme.services.v1.authz.impl.BetterMeAuthorizationImpl;
...
@EnableAutoWeld
@AddBeanClasses(BetterMeAuthorizationImpl.class)
