package eu.tealhelix.betterme.services.v1.authz;

import eu.tealhelix.common.v1.model.User;
import io.smallrye.mutiny.Uni;

/**
 * Module-specific methods for authorizing the access to the services of BetterMe.
 */
public interface BetterMeAuthorization {
	/**
