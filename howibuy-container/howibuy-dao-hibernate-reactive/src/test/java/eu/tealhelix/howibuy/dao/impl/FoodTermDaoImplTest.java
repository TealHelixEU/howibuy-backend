...
public class FoodTermDaoImplTest {
	 ...
	 * exercise the nullable {@code category_hint} column.
	 */
	@BeforeAll
	static void seedGlossary(Mutiny.SessionFactory sessionFactory) {
		var factory = new ReactivePersistenceContextFactoryImpl(sessionFactory);
		var anthotyros = foodTerm("el", "Ανθότυρος", "anthotyros", "Greek whey cheese, similar to ricotta or mizithra", "Milk and dairy products");
		var vlita = foodTerm("el", "Βλήτα", "amaranth greens", "amaranth greens, a leafy green vegetable", null);
		var varske = foodTerm("lt", "Varškė", "curd cheese", "fresh curd cheese", "Milk and dairy products");
	...
	private static FoodTermEntity foodTerm(String lang, String term, String canonicalEn, String description, String categoryHint) {
		...
		entity.setCategoryHint(categoryHint);
		return entity;
	}
}
