...
import static eu.tealhelix.howibuy.dao.jpa.values.ConsentState.GRANTED;
import static eu.tealhelix.howibuy.dao.jpa.values.ConsentState.REVOKED;
...
import eu.tealhelix.howibuy.dao.jpa.ConsentEntity;
...
import eu.tealhelix.howibuy.v1.types.HasRetailerId;
