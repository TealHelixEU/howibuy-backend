 ...
 * <ul>
 *     <li>{@code CategoryId}, {@code QuestionId}, {@code ProductKey}, {@code ArchetypeProductId} —
 *     {@code RepresentableAsString} ids rendered by a Jackson serializer, otherwise introspected as a recursive
 *     object;</li>
