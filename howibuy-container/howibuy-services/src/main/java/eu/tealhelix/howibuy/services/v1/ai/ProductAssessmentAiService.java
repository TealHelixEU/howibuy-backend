...
public interface ProductAssessmentAiService {
	...
	String extractL1Category(String lang, String name, String enrichment, String characteristics, String tags, String categories);
	...
	String extractSubcategory(String lang, String name, String enrichment, String characteristics, String tags, String categories);
