...
public class RepresentableAsStringKeySerializer extends JsonSerializer<RepresentableAsString> {
	@Override
	public void serialize(RepresentableAsString representableAsString, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
		...
		jsonGenerator.writeFieldName(representableAsString.asString());
	}
}
